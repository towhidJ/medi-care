    ...
    return (
        <div className="flex items-center h-screen w-full bg-teal-lighter bg-gray-300 ">
            <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto space-y-3">
                    ...
                    <h1 className="font-bold text-2xl text-yellow-500 text-center">Sign In</h1>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="flex flex-col mb-4 md:w-full">
                                    ...
                                    <input {...register("email")} className="loginInput" />
                                    <span className="text-red-500">{errors.email?.message}</span>
                                </div>
                                <div className="flex flex-col mb-4 md:w-full">
                                    <label className="loginLabel"
                                           htmlFor="password">Password</label>
                                    <input {...register("password", { required:true,})}  className="loginInput text-gray-900" />
                                    <span className="text-red-500">{errors.password?.message}</span>
                                </div>
                                <div><button className="w-full text-white font-extrabold bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 rounded px-5 py-2" type="submit" > Login</button></div>
