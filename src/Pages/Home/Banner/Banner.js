            ...
            <section class=" bg-blue-50 container-fluid md:flex justify-around items-center pt-12 px-8">
                <div class="space-y-4">
                    <h1 class="text-4xl md:text-7xl font-bold uppercase">
                        <span class="text-yellow-400">Best Medical Center</span>
                        <br />
                    ...
                    <button class=" bg-gradient-to-r from-red-500 via-red-800 to-red-400 text-white uppercase px-7 py-4 rounded-xl font-medium hover:bg-blue-300">
                        <svg
