                        ...
                        <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
                            ...
                            <div className="p-5">
                                ...
                                <p className="font-normal text-gray-700 mb-3">
                                    All data and statistics are based on
                                    publicly available data at the time of
                                    publication. Some information may be out of
                                    date.....
                                </p>
                                <a
                        ...
                        <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
                            ...
                            <div className="p-5">
                                ...
                                <p className="font-normal text-gray-700 mb-3">
                                    ...
                                    deliver information to human cells and
                                    elicit an immune response. DNA vaccines are
                                    safe, easy, affordable to produce, and,
                                    unlike RNA vaccines, are stable at room
                                    temperature. These attributes make them more
                                    promising for rapidly immunizing
                    ...
                    <div className="max-w-lg mx-auto">
                        <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
                            ...
                            <div className="p-5">
                                ...
                                <p className="font-normal text-gray-700 mb-3">
                                    A diverse, multidisciplinary team of
                                    scientists worked on a creative research
                                    design to uncover sleep patterns in people
                                    living with mental health conditions or a
                                    genetic predisposition to them. Their
